...
class NominaUtils {
    ...
    static String xsiSchemaLocation = "http://www.sat.gob.mx/cfd/3 http://www.sat.gob.mx/sitio_internet/cfd/3/cfdv33.xsd http://www.sat.gob.mx/nomina12 http://www.sat.gob.mx/sitio_internet/cfd/nomina/nomina12.xsd"

    private static Schema schema = null

    public static JAXBContext getContext(){
        JAXBContext context = JAXBContext.newInstance(Comprobante.class, Nomina.class)
        return context
    }
